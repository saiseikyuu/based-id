...
const QUESTS: Array<Quest & { check: (s: Stats) => boolean; progress?: (s: Stats) => { current: number; total: number } }> = [
  ...
  // ── Rank milestones ────────────────────────────────────────────
  {
    id: "rank_d",
    title: "Reach D-Rank",
    description: "Earn 100 XP to achieve D-Rank Hunter.",
    xp: 50,
    type: "milestone",
    category: "hunters",
    check: (s) => s.baseXp >= 100,
    progress: (s) => ({ current: Math.min(s.baseXp, 100), total: 100 }),
  },
  {
    id: "rank_c",
    title: "Reach C-Rank",
    description: "Earn 300 XP to achieve C-Rank Hunter.",
    xp: 100,
    type: "milestone",
    category: "hunters",
  ...
  },
  {
    id: "rank_b",
    title: "Reach B-Rank",
    description: "Earn 700 XP to achieve B-Rank Hunter.",
    xp: 200,
    type: "milestone",
    category: "hunters",
    check: (s) => s.baseXp >= 700,
    progress: (s) => ({ current: Math.min(s.baseXp, 700), total: 700 }),
  },
  {
    id: "rank_a",
    title: "Reach A-Rank",
    description: "Earn 1500 XP to achieve A-Rank Hunter.",
    xp: 300,
    type: "milestone",
    category: "hunters",
    check: (s) => s.baseXp >= 1500,
    progress: (s) => ({ current: Math.min(s.baseXp, 1500), total: 1500 }),
  },
