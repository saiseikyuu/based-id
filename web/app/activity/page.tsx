      ...
      <div className="border-b border-white/[0.05] px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            <Link href="/leaderboard" className="text-zinc-600 text-[11px] uppercase tracking-[0.15em] hover:text-white transition-colors">Leaderboard</Link>
            <Link href="/dashboard" className="text-zinc-600 text-[11px] uppercase tracking-[0.15em] hover:text-white transition-colors">Dashboard</Link>
          </div>
        </div>
      </div>
